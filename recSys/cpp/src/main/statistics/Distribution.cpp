...
void Distribution::read_from_file(string file_name, int colNum, int actCol){
  ifstream ifs;
...
void Averaging::read_from_file(string file_name, int colNum, int actColX, int actColY){
