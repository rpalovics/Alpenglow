#ifndef CLASS _RANDOM_CHOOSING_COMBINED_MODEL_EXPERT_UPDATER
#define CLASS _RANDOM_CHOOSING_COMBINED_MODEL_EXPERT_UPDATER
...
#endif /* CLASS _RANDOM_CHOOSING_COMBINED_MODEL_EXPERT_UPDATER */
